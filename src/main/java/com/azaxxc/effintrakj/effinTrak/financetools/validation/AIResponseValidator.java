...
public class AIResponseValidator {
    ...
    public ValidationResult validateIntent(String intent) {
        ...
        List<String> allowedIntents = List.of(
            ...
            "CREATE_SAVINGS_GOAL", "GET_SAVINGS_PROGRESS", "ADD_TO_SAVINGS", "WITHDRAW_FROM_SAVINGS",
            "UPDATE_BUDGET", "ADD_SUBSCRIPTION", "GET_ACTIVE_SUBSCRIPTIONS", "CANCEL_SUBSCRIPTION",
            "ADD_CREDIT", "GET_ACTIVE_CREDITS", "MAKE_CREDIT_PAYMENT", "TRANSFER_MONEY",
            "CREATE_RECURRING_TRANSACTION", "GET_ACTIVE_RECURRING_TRANSACTIONS",
            "PAUSE_RECURRING_TRANSACTION", "DELETE_RECURRING_TRANSACTION",
